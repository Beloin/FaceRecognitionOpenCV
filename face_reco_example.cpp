  ...
  if (parser.has("image1")) {
    ...
    if (parser.has("image2")) {
      ...
      Ptr<FaceRecognizerSF> faceRecognizer =
          FaceRecognizerSF::create(fr_modelPath, "");

      // Aligning and cropping facial image through the first face of faces
      // detected.
      ...
      double cos_score = faceRecognizer->match(
          feature1, feature2, FaceRecognizerSF::DisType::FR_COSINE);
      double L2_score = faceRecognizer->match(
          feature1, feature2, FaceRecognizerSF::DisType::FR_NORM_L2);
      ...
      std::cout << " Cosine Similarity: " << cos_score
                << ", threshold: " << cosine_similar_thresh
      ...
      std::cout << " NormL2 Distance: " << L2_score
                << ", threshold: " << l2norm_similar_thresh
    ...
    if (capture.isOpened()) {
      ...
      cout << "Video " << video << ": width=" << frameWidth
